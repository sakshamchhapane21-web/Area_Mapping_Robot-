...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # 5. RTAB-Map (Now fusing 2D LiDAR and 3D Camera)
        Node(package='rtabmap_slam', executable='rtabmap', name='rtabmap',
             ...
             parameters=[{
                 ...
                 'subscribe_scan_cloud': True,   # 3D Camera Cloud
                 'subscribe_scan': True,         # NEW: Turn on 2D LiDAR subscription
                 'subscribe_imu': True,          
             ...
             remappings=[
                 ...
                 ('scan', '/scan'),              # NEW: Route the LiDAR topic into RTAB-Map
                 ('imu', '/imu'),                
